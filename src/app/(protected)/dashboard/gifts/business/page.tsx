...
import { GIFTS_BUSINESS_TABS_MAP } from "../_utils/constants";
...
const Page = () => {
  const { defaultTabValue, current, api, setAPI, goBack, goToNext } =
    useCarouselAPI({
      tabsMap: GIFTS_BUSINESS_TABS_MAP,
    });
          ...
          >
            <CarouselContent>
              <CarouselItem>
                <CustomerFormProvider>
                  <CustomerOperationProvider
                    type={GIFTS_BUSINESS_TABS_MAP.saler}
              ...
              <CarouselItem>
                <CustomerFormProvider>
                  <CustomerOperationProvider
                    type={GIFTS_BUSINESS_TABS_MAP.buyer}
                    carouselAction={{ goBack, goToNext }}
                  >
                    <CustomerIdentityRegisteration />
                  </CustomerOperationProvider>
              ...
              <CarouselItem>
                <CustomerFormProvider>
                  <CustomerOperationProvider
                    type={GIFTS_BUSINESS_TABS_MAP.withness}
                    carouselAction={{ goBack, goToNext }}
                  >
                    <CustomerIdentityRegisteration />
                  </CustomerOperationProvider>
              ...
              <CarouselItem>
                <ServiceRequest serviceType={ServiceType.GIFTS_BUSINESS} />
              </CarouselItem>
            </CarouselContent>
          </Carousel>
        </BusinessContextProvider>
